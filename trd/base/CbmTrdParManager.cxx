...
void CbmTrdParManager::FillModuleMap()
{
   ...
   // TRD modules.
  //printf("CbmTrdParManager::FillModuleMap()\n");
...
void CbmTrdParManager::CreateModule(
...
*/   
  ...
  printf("CbmTrdParManager::CreateModule(%s %c) type[%d]\n", path.Data(), (tripad?'y':'n'), moduleType);
...
//    // Create new CbmTrdModuleSim and add it to the map
//    fModuleMap[moduleAddress] = new CbmTrdModuleSim(moduleAddress, orientation, x, y, z,
