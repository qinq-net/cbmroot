...
#ifndef CBMPSDWOUTV1_FOR44MODS_SUB1_H
#define CBMPSDWOUTV1_FOR44MODS_SUB1_H
...
class CbmPsdWoutv1_for44mods_sub1 : public CbmPsd
{

 public:

  /** Default constructor **/
  CbmPsdWoutv1_for44mods_sub1();
   ...
   **/
  CbmPsdWoutv1_for44mods_sub1(const char* name, Bool_t active);


  /** Destructor **/
  virtual ~CbmPsdWoutv1_for44mods_sub1();
 ...
 private:
  ...
  ClassDef(CbmPsdWoutv1_for44mods_sub1,3)

};

inline void CbmPsdWoutv1_for44mods_sub1::ResetParameters() {
