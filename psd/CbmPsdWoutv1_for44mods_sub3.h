...
#ifndef CBMPSDWOUTV1_FOR44MODS_SUB3_H
#define CBMPSDWOUTV1_FOR44MODS_SUB3_H
...
class CbmPsdWoutv1_for44mods_sub3 : public CbmPsd
{

 public:

  /** Default constructor **/
  CbmPsdWoutv1_for44mods_sub3();
   ...
   **/
  CbmPsdWoutv1_for44mods_sub3(const char* name, Bool_t active);


  /** Destructor **/
  virtual ~CbmPsdWoutv1_for44mods_sub3();
...
inline void CbmPsdWoutv1_for44mods_sub3::ResetParameters() {
