...
#include "CbmPsdWoutv1_for48mods_sub1.h"
...
// -----   Default constructor   -------------------------------------------
CbmPsdWoutv1_for48mods_sub1::CbmPsdWoutv1_for48mods_sub1() {
...
CbmPsdWoutv1_for48mods_sub1::CbmPsdWoutv1_for48mods_sub1(const char* name, Bool_t active)
  : CbmPsd(name, active) {
}
...
Bool_t  CbmPsdWoutv1_for48mods_sub1::ProcessHits(FairVolume* vol)
{
  //  cout<<" CbmPsdWoutv1_for48mods_sub1::ProcessHits in "<<vol->GetName()<<endl;
...
void CbmPsdWoutv1_for48mods_sub1::CreateMaterial() {
}
// -----   Public method ConstructGeometry   -------------------------------
void CbmPsdWoutv1_for48mods_sub1::ConstructGeometry() {
...
//Holes in WOUT
  ...
  gGeoManager->Node("VHLE", 5, "WOUT", -70., -50., 0., 0,kTRUE, buf, 0); 
  */
  /*
...
ClassImp(CbmPsdWoutv1_for48mods_sub1)
