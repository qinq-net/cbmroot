...
#include "CbmPsdv1_48mods_hole6cm.h"
...
// -----   Default constructor   -------------------------------------------
CbmPsdv1_48mods_hole6cm::CbmPsdv1_48mods_hole6cm() {
...
CbmPsdv1_48mods_hole6cm::CbmPsdv1_48mods_hole6cm(const char* name, Bool_t active)
  : CbmPsd(name, active) {
}
...
Bool_t  CbmPsdv1_48mods_hole6cm::ProcessHits(FairVolume* vol)
{
  //  cout<<" CbmPsdv1_48mods_hole6cm::ProcessHits in "<<vol->GetName()<<endl;
...
void CbmPsdv1_48mods_hole6cm::CreateMaterial() {
}
// -----   Public method ConstructGeometry   -------------------------------
void CbmPsdv1_48mods_hole6cm::ConstructGeometry() {
...
// Create materials, media and volume
  ...
  TGeoVolume *VETO = gGeoManager->MakeBox("VETO",med1, 100, 60, 62.4);
...
//48 mods  
  ...
  for(Int_t iy=0; iy<6; iy++) 
  {
    ...
    {
      iMod++;
      if(iMod==1 || iMod==2 || iMod==9 || iMod==10 || iMod==11 || iMod==20 || iMod==41 || iMod==50 || iMod==51 || iMod==52 || iMod==59 || iMod==60) 
      {
      	gGeoManager->Node("VHLL", iMod, "VETO", xCur,yCur,0,  0,kTRUE, buf, 0); 
	cout <<"HOLE::::iMod,xxxx,yyyy " <<iMod <<" " <<xCur <<" " <<yCur <<endl;
      }
      ...
      {
	iModNoHole++;
	if(iModNoHole==19) {//module with hole
	  //iModNoHole++;
	  gGeoManager->Node("VMHC", iModNoHole, "VETO", -10.,-10.,0, 0, kTRUE, buf, 0); 
	  xi[iModNoHole-1] = -10. + xPSD;
	  yi[iModNoHole-1] = -10.;        
	...
	else if(iModNoHole==20) {//module with hole
	  //iModNoHole++;
	  gGeoManager->Node("VMHD", iModNoHole, "VETO", 10.,-10.,0, 0, kTRUE, buf, 0); 
	  xi[iModNoHole-1] = 10. + xPSD;
	  yi[iModNoHole-1] = -10.;        
	...
	else if(iModNoHole==29) {//module with hole
	  //iModNoHole++;
	  gGeoManager->Node("VMHB", iModNoHole, "VETO", -10.,10.,0, 0, kTRUE, buf, 0); 
	  xi[iModNoHole-1] = -10. + xPSD;
	  yi[iModNoHole-1] = 10.;     
	...
	else if(iModNoHole==30) {//module with hole
	  //iModNoHole++;
	  gGeoManager->Node("VMHA", iModNoHole, "VETO", 10.,10.,0, 0, kTRUE, buf, 0); 
	  xi[iModNoHole-1] = 10. + xPSD;
	  yi[iModNoHole-1] = 10.;        
	...
	if(iModNoHole!=19 && iModNoHole!=20 && iModNoHole!=29 && iModNoHole!=30) {//for 4 mods with holes
	  cout <<"MODULE :::::iMod,xxxx,yyyy " <<iModNoHole <<" " <<xCur <<" " <<yCur <<endl;
...
ClassImp(CbmPsdv1_48mods_hole6cm)
