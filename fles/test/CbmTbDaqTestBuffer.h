/** @file CbmDaqTestBuffer.h
 ** @author Volker Friese <v.friese@gsi.de>
 ** @date 17 July 2012
 ** updated 21.06.16 F.Uhlig
 **/

#ifndef CBMTBDAQTESTBUFFER_H
#define CBMTBDAQTESTBUFFER_H 1
 ...
 **
 ** The CbmTbDaqTestBuffer stores and sorts (w.r.t. time) CBM raw data
...
class CbmTbDaqTestBuffer
{
  public:
     ...
     **/
    static CbmTbDaqTestBuffer* Instance();
  ...
  private:
    ...
    static CbmTbDaqTestBuffer* fgInstance;
    ...
    CbmTbDaqTestBuffer(const CbmTbDaqTestBuffer&);


    /**  Assignment operator. Defined private to prevent usage. **/
    CbmTbDaqTestBuffer& operator=(const CbmTbDaqTestBuffer&);



};

#endif /* CBMTBDAQTESTBUFFER_H */
