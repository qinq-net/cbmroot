...
*/
  ...
  if (server)
  {
    server->RegisterCommand("/Reset_All_TOF", "bResetTofStarMoniShiftHistos=kTRUE");
    server->RegisterCommand("/Save_All_Tof", "bSaveTofStarMoniShiftHistos=kTRUE");

    server->RegisterCommand("/Update_Norm_FT", "bTofUpdateNormedFtMoniShift=kTRUE");

    if( fbPulserMode )
      server->RegisterCommand("/Update_Zoom_Fit", "bTofUpdateZoomedFitMoniShift=kTRUE");
...
void CbmTofStarMonitorShift2018::FillHitInfo(ngdpb::Message mess)
{
...
void CbmTofStarMonitorShift2018::FillEpochInfo(ngdpb::Message mess)
{
...
void CbmTofStarMonitorShift2018::PrintSlcInfo(ngdpb::Message mess)
{
...
void CbmTofStarMonitorShift2018::PrintGenInfo(ngdpb::Message mess)
{
...
void CbmTofStarMonitorShift2018::PrintSysInfo(ngdpb::Message mess)
{
  if (fGdpbIdIndexMap.end() != fGdpbIdIndexMap.find(fGdpbId))
...
void CbmTofStarMonitorShift2018::FillStarTrigInfo(ngdpb::Message mess)
{
...
void CbmTofStarMonitorShift2018::FillTrigEpochInfo(ngdpb::Message mess)
{
...
void CbmTofStarMonitorShift2018::UpdateNormedFt()
{
...
void CbmTofStarMonitorShift2018::SetRunStart( Int_t dateIn, Int_t timeIn, Int_t iBinSize )
{
...
void CbmTofStarMonitorShift2018::SetPulserChans(
