...
CbmTrdRawBuchData::CbmTrdRawBuchData()
  : FairTask("CbmTrdRawBuchData"),
    ...
    fTrbBuffer()
{
  LOG(DEBUG) << "Default Constructor of CbmTrdRawBuchData" << FairLogger::endl;
}
...
CbmTrdRawBuchData::~CbmTrdRawBuchData()
{
  ...
  fTimeBuffer.clear();
    ...
    LOG(DEBUG) << "Destructor of CbmTrdRawBuchData" << FairLogger::endl;
}

  // ----  Initialisation  ----------------------------------------------
  void CbmTrdRawBuchData::SetParContainers()
  {
    LOG(DEBUG) << "SetParContainers of CbmTrdRawBuchData" << FairLogger::endl;
  ...
  {
    LOG(DEBUG) << "Initilization of CbmTrdRawBuchData" << FairLogger::endl;
...
//      for (secondTimeIt ; secondTimeIt != (MSIt->second).end(); secondTimeIt++){
  ...
  {
    LOG(INFO) << "CbmTrdRawBuchData::Clusterizer              :  SuperEpoch: " << fSuperEpoch << "  Epoch: " << fEpoch << FairLogger::endl;
    /*
  ...
  {
    if (raw == NULL){
      LOG(ERROR) << "CbmTrdRawBuchData::GetModuleID: CbmSpadicRawMessage == NULL" << FairLogger::endl;
      return -1;
    } else {
  ...
  {
    if (raw == NULL)
      LOG(ERROR) << "CbmTrdRawBuchData::GetSectorID: CbmSpadicRawMessage == NULL" << FairLogger::endl;
    return 0;
  }
  Int_t CbmTrdRawBuchData::GetRowID(CbmSpadicRawMessage* raw)
  {
    if (raw == NULL)
      LOG(ERROR) << "CbmTrdRawBuchData::GetRowID: CbmSpadicRawMessage == NULL" << FairLogger::endl;
    Int_t chID = raw->GetChannelID();
    Int_t sourceA = raw->GetSourceAddress();
    switch (sourceA) {
    case (SpadicBaseAddress+0):  // first spadic
  ...
  {
    if (raw == NULL)
      LOG(ERROR) << "CbmTrdRawBuchData::GetColumnID: CbmSpadicRawMessage == NULL" << FairLogger::endl;
    Int_t chID = raw->GetChannelID();
    Int_t sourceA = raw->GetSourceAddress();
    switch (sourceA) {
    case (SpadicBaseAddress+0):  // first spadic
  ...
  Int_t CbmTrdRawBuchData::GetChannelOnPadPlane(Int_t SpadicChannel)
  {
    ...
    if (SpadicChannel < 0 || SpadicChannel > 31){
      LOG(ERROR) << "CbmTrdRawBuchData::GetChannelOnPadPlane ChId " << SpadicChannel << FairLogger::endl;
      return -1;
    } else {
...
Int_t CbmTrdRawBuchData::GetCombiID(CbmSpadicRawMessage* raw)
{
  ...
  void CbmTrdRawBuchData::Finish()
  {
    Clusterizer();
    TimeClustering2015CernSPS();
    LOG(DEBUG) << "Finish of CbmTrdRawBuchData" << FairLogger::endl;
    // Write to file
    fHM->WriteToFile();
    // Update Histos and Canvases
  
    LOG(INFO) << "CbmTrdRawBuchData::Finish Container:            " << fContainerCounter << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Spadic Messages:      " << fSpadicMessageCounter << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Nxyter Messages:      " << fNxyterMessageCounter << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Trb Messages:         " << fTrbMessageCounter << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Infos:                " << fInfoCounter << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Hits:                 " << fHitCounter << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Multihits:            " << fMultiHitCounter << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Errors:               " << fErrorCounter << " (stoptype != 0 && != 3)" << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish LostHits:             " << fLostHitCounter << " (buffer full)" << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Identical Messages:   " << fDoubleCounter << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Fragemented Signals:  " << fFragmentedCounter <<  FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Digis:                " << fDigis->GetEntriesFast() << FairLogger::endl;
    LOG(INFO) << "CbmTrdRawBuchData::Finish Clusters:             " << fClusters->GetEntriesFast() << FairLogger::endl;
  }
