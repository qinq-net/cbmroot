...
void CbmTSUnpackSpadic20DesyOnlineMonitor::FillEpochInfo(Int_t link, Int_t addr, Int_t epoch_count)
{
...
void CbmTSUnpackSpadic20DesyOnlineMonitor::GetEpochInfo(Int_t link, Int_t addr)
{
...
{
  if(SpadicChannel > 31 || groupId > 1) LOG(DEBUG) << "CbmTSUnpackSpadic20DesyOnlineMonitor::                     ChId " << SpadicChannel << "  GroupId: " << groupId << FairLogger::endl;
...
Int_t CbmTSUnpackSpadic20DesyOnlineMonitor::GetSyscoreID(Int_t link)
{
  /*
