...
namespace get4v1x {
   ...
   class Message {
      ...
      public:
         ...
         inline uint8_t   getGet4V10R32ChipId()      const { return getField( 4, 6); }
            // type 1 => Slow control
         inline uint8_t   getGet4V10R32SlChan()      const { return getField( 10, 2); }
         inline bool      getGet4V10R32SlEdge()      const { return getBit(   12); }
         inline uint8_t   getGet4V10R32SlType()      const { return getField( 13, 2); }
         inline uint32_t  getGet4V10R32SlData()      const { return getField( 16,24); }
            // type 2 => Error message: encapsulated in SysMes subtype SYSMSG_GET4_EVENT
         inline uint8_t   isGet4Err24bit()           const { return 0x10  == getField( 24, 2); }
         inline uint8_t   isGet4Err32bit()           const { return 0x100 == getField( 16, 3); }
               // 24 bits mode
         ...
         inline uint8_t   getGet4V10R24ErrorData()   const { return getField( 41, 7); }
               // 32 bits mode
         inline bool      getGet4V10R32ErrorEdge()   const { return getBit(   19); }
         inline uint8_t   getGet4V10R32ErrorChan()   const { return getField( 20, 2); }
         inline uint16_t  getGet4V10R32ErrorUnused() const { return getField( 22,13); }
         inline uint8_t   getGet4V10R32ErrorChip()   const { return getField( 35, 6); }
         inline uint8_t   getGet4V10R32ErrorData()   const { return getField( 41, 7); }
            // type 3 => Hit Data
         inline uint8_t   getGet4V10R32HitChan()     const { return getField( 10, 2); }
         inline bool      getGet4V10R32HitDllFlag()  const { return getBit(   12); }
         inline uint32_t  getGet4V10R32HitTs()       const { return getField( 13,12); }
         inline uint8_t   getGet4V10R32HitFt()       const { return getField( 24, 7); }
         inline uint32_t  getGet4V10R32HitTimeBin()  const { return getField( 13,19); }
         inline uint8_t   getGet4V10R32HitTot()      const { return getField( 32, 8); }
         inline uint32_t  getGet4V10R32HitCRC()      const { return getField( 40, 8); }
