...
namespace get4v1x {
   ...
   class Message {
      ...
      public:
         ...
         // ---------- Get4 v1.x 24b data access methods ----------------
         ...
         inline bool     getGet4V10R32SyncFlag()    const { return getBitBE(   16); }
            // type 1 => Slow control
         ...
         inline bool     getGet4V10R32SlEdge()      const { return getBitBE(   42); }
         ...
         inline uint16_t getGet4V10R32ErrorUnused() const { return getFieldBE( 23,19); }
         inline uint8_t  getGet4V10R32ErrorChan()   const { return getFieldBE( 42, 2); }
         inline bool     getGet4V10R32ErrorEdge()   const { return getBitBE(   44); }
            // type 3 => Hit Data
         ...
         inline uint16_t getGet4V10R32HitTs()       const { return getFieldBE( 31,12); }
