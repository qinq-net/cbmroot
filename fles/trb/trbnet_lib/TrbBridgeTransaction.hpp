...
public:
    ...
    * Frame Number
    * 
    * @return number of next frame expected (corresponds to the number of frames imported). still valid after transaction is closed
    */
    ...
    */
   constexpr static size_t MAX_SIZE = 65536;
