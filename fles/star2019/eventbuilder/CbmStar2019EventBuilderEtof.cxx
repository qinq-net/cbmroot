...
void CbmStar2019EventBuilderEtof::SetEventBuildingMode( Bool_t bEventBuildingMode )
{
...
void CbmStar2019EventBuilderEtof::SetTimeSortOutput( Bool_t bTimeSort )
{
...
void CbmStar2019EventBuilderEtof::CbmStar2019EventBuilderEtof::CreateHistograms()
{
...
//                   4000, -800000.0, 0.0) ); // TODO make offset parameter
      ...
      if( kFALSE == fbEventBuilding )
      {
         ...
         uNbBins = static_cast< UInt_t >( CbmTofStarSubevent2019::GetMaxOutputSize() / 8 ); // 1 bin = 1 long 64b uint
         fhStarEventSize_gDPB.push_back(
            new TH1I( name.Data(), title.Data(),
                      uNbBins, 0.0, CbmTofStarSubevent2019::GetMaxOutputSize() ) );
#ifdef USE_HTTP_SERVER
         if (server)
         ...
         uNbBins = static_cast< UInt_t >( CbmTofStarSubevent2019::GetMaxOutputSize()
                                               / (sizeof( gdpb::Message )) );
   ...
   if( kTRUE == fbEventBuilding )
   {
      ...
      UInt_t uNbBins = static_cast< UInt_t >( CbmTofStarSubevent2019::GetMaxOutputSize() / 8 ); // 1 bin = 1 long 64b uint
      fhStarEventSize = new TH1I( name.Data(), title.Data(), uNbBins, 0.0, CbmTofStarSubevent2019::GetMaxOutputSize() );
#ifdef USE_HTTP_SERVER
      if (server)
...
Bool_t CbmStar2019EventBuilderEtof::DoUnpack(const fles::Timeslice& ts, size_t component)
{
   ...
   else if( fdMoniOutIntervalSec < elapsed_seconds.count() )
   {
      ...
      LOG(INFO) << "CbmStar2019EventBuilderEtof::DoUnpack => " << tempBuff
      ...
      if( kTRUE == fbEventBuilding )
      {
         ...
         else LOG(INFO) << "CbmStar2019EventBuilderEtof::DoUnpack => " << tempBuff
...
void CbmStar2019EventBuilderEtof::FillHitInfo( gdpb::Message mess )
{
...
void CbmStar2019EventBuilderEtof::FillEpochInfo( gdpb::Message mess )
{
...
void CbmStar2019EventBuilderEtof::PrintSlcInfo(gdpb::Message mess)
{
...
void CbmStar2019EventBuilderEtof::PrintGenInfo(gdpb::Message mess)
{
...
void CbmStar2019EventBuilderEtof::PrintSysInfo(gdpb::Message mess)
{
/*
...
void CbmStar2019EventBuilderEtof::FillStarTrigInfo(gdpb::Message mess)
{
...
void CbmStar2019EventBuilderEtof::SaveAllHistos( TString sFileName )
{
...
void CbmStar2019EventBuilderEtof::ResetAllHistos()
{
...
void CbmStar2019EventBuilderEtof::ResetEvolutionHistograms()
{
   for( UInt_t uGdpb = 0; uGdpb < fuNrOfGdpbs; ++uGdpb )
   {
      fhTriggerRate[ uGdpb ]->Reset();
...
void CbmStar2019EventBuilderEtof::ResetLongEvolutionHistograms()
{
   for( UInt_t uGdpb = 0; uGdpb < fuNrOfGdpbs; ++uGdpb )
   {
      fhTriggerRate[ uGdpb ]->Reset();
...
void CbmStar2019EventBuilderEtof::BuildStarEventsSingleLink()
{
...
void CbmStar2019EventBuilderEtof::BuildStarEventsAllLinks()
{
   /// TODO:
...
//                        std::cout << Form( "Event %6llu Trigger message in Overlap for gDPB %02u is %016lx ", fulNbBuiltSubEvent, uGdpb, (*itMess).getData() ) << std::endl;
            ...
            {
               CbmTofStarTrigger2019 meanTriggerOver( static_cast< ULong64_t >( dMeanTriggerGdpbTsOver ), static_cast< ULong64_t >( dMeanTriggerStarTsOver ),
