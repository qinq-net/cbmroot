...
private:
   ...
   CbmTofStarSubevent2019 fStarSubEvent;
   ...
   std::vector< CbmTofStarTrigger2019  > fvtCurrentLinkBuffer; //! M1, Used in case of single link per subevent: test mode in 2018 S1, sector mode in 2018 S2
   ...
   std::vector< std::vector < CbmTofStarTrigger2019  > > fvtTsLinksBuffer; //! M2, Used in case of all links in same subevent: Sector mode in 2018 S1, Full eTOF mode in 2018 S2
   ...
   std::vector< std::vector < CbmTofStarTrigger2019  > > fvtTsOverLinksBuffer; //! M2, Used in case of all links in same subevent: Sector mode in 2018 S1, Full eTOF mode in 2018 S2
