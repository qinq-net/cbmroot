...
{
   LOG(INFO) << "Initializing mCBM MUCH 2019 unpacker algo" << FairLogger::endl;
...
// -------------------------------------------------------------------------
void CbmMcbm2018UnpackerAlgoMuch::ProcessHitInfo( stsxyter::Message mess, const UShort_t & usElinkIdx, const UInt_t & uAsicIdx, const UInt_t & uMsIdx )
{
...
void CbmMcbm2018UnpackerAlgoMuch::ProcessTsMsbInfo( stsxyter::Message mess, UInt_t uMessIdx, UInt_t uMsIdx )
{
...
void CbmMcbm2018UnpackerAlgoMuch::ProcessEpochInfo( stsxyter::Message mess )
{
...
void CbmMcbm2018UnpackerAlgoMuch::ProcessStatusInfo( stsxyter::Message mess )
{
/*
   UInt_t   uCrobIdx   = usElinkIdx / fUnpackPar->GetNbElinkPerCrob();
   Int_t   uFebIdx    = fUnpackPar->ElinkIdxToFebIdx( usElinkIdx );
