...
///++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++///
   ...
   LOG(DEBUG)<< "Initialized 4th Histo before SXM 2.0 Logic Error" << FairLogger::endl;
///++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++///
///----------------- SXM 2.0 Logic Error Tagging --------------------///
   for( UInt_t uFebIdx = 0; uFebIdx < fuNbFebs; ++uFebIdx )
   {
...
*/
   ...
   //LOG(INFO)<<" full time "<<fvdChanLastHitTime[ uAsicIdx ][ usChan ]<<" start time "<<fdStartTime<<" dTimeSinceStartSec "<<dTimeSinceStartSec<<" dTimeSinceStartSec*1e-9 "<<dTimeSinceStartSec*1e+9<< " fvulChanLastHitTime[ uAsicIdx ][ usChan ] "<<fvulChanLastHitTime[ uAsicIdx ][ usChan ]<< " usChan "<<usChan<<" usrawadc "<<usRawAdc<<FairLogger::endl;
   fviFebCountsSinceLastRateUpdate[uFebIdx]++;
   fvdFebChanCountsSinceLastRateUpdate[uFebIdx][uChanInFeb] += 1;
   //LOG(INFO)<<" fviFebCountsSinceLastRateUpdate "<<fviFebCountsSinceLastRateUpdate[uFebIdx]<<" fvdFebChanCountsSinceLastRateUpdate "<<fvdFebChanCountsSinceLastRateUpdate[uFebIdx][uChanInFeb] <<" uFebIdx " << uFebIdx << FairLogger::endl;
...
void CbmMcbm2018MonitorMuch::Finish()
{
   ...
   LOG(INFO) << "-------------------------------------" << FairLogger::endl;
   LOG(INFO) << "CbmMcbm2018MonitorMuch statistics are " << FairLogger::endl;
...
void CbmMcbm2018MonitorMuch::FillOutput(CbmDigi* /*digi*/)
{
}
