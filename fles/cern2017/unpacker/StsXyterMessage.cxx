...
//+++++++++++++++++++++++++ TS_MSB message OP ++++++++++++++++++++++++++++++++
//----------------------------------------------------------------------------
uint16_t Message::TsMsbCrcCalc() const
{
#ifdef USE_VHDL_CRC
...
//----------------------------------------------------------------------------
bool     Message::TsMsbCrcCheck() const
{
   return ( TsMsbCrcCalc() == GetTsMsbCrc() );
}
//----------------------------------------------------------------------------
bool     Message::TsMsbTsCheck() const
{
...
//----------------------------------------------------------------------------
uint16_t Message::GetTsMsbMajCnt() const
{
   uint16_t uValA = GetTsMsbValA();
...
//----------------------------------------------------------------------------
bool     Message::GetTsMsbValCorr( uint16_t & uVal ) const
{
   uint16_t uValA = GetTsMsbValA();
...
//----------------------------------------------------------------------------
uint16_t Message::RdDataCrcCalc() const
{
#ifdef USE_VHDL_CRC
...
//----------------------------------------------------------------------------
bool     Message::RdDataCrcCheck() const
{
...
//+++++++++++++++++++++++++ Ack message OP +++++++++++++++++++++++++++++++++++
//----------------------------------------------------------------------------
uint16_t Message::AckCrcCalc() const
{
#ifdef USE_VHDL_CRC
...
//----------------------------------------------------------------------------
bool     Message::AckCrcCheck() const
{
...
bool     Message::PrintMess(std::ostream& os, MessagePrintMask ctrl ) const
{
   ...
   bool bPrintCrc    = static_cast< bool >(ctrl & MessagePrintMask::msg_print_Crc);
...
//----------------------------------------------------------------------------
#ifndef USE_VHDL_CRC
uint16_t Message::CalcCrc3Pol5Len21( uint32_t uVal ) const
{
   uint32_t uValMask = uVal & ( (1 << 21) - 1 );
   return CRCPP::CRC::Calculate( &uValMask, sizeof(uValMask), table_crc3_5);
}
//----------------------------------------------------------------------------
uint16_t Message::CalcCrc4Pol9Len20( uint32_t uVal ) const
{
...
#endif // not USE_VHDL_CRC
//----------------------------------------------------------------------------
uint16_t Message::VhdlCalcCrc3Pol5Len21( uint32_t uVal ) const
{
/*
  function crc3_d21 (
...
//----------------------------------------------------------------------------
uint16_t Message::VhdlCalcCrc4Pol9Len20( uint32_t uVal ) const
{
/*
  function crc4_d20 (
