...
class CbmStsUnpackPar : public FairParGenericSet 
{
  
 public:
  
  /** Standard constructor **/
  CbmStsUnpackPar(const char* name    = "CbmStsUnpackPar",
		   const char* title   = "STS unpacker parameters",
		   const char* context = "Default");
  
  
  /** Destructor **/
  virtual ~CbmStsUnpackPar();
