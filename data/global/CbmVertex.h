...
/** @class CbmVertex
 ** @brief Data class for a vertex in CBM.
 ** @author V. Friese <v.friese@gsi.de>
 ** @version 2.0
 **/
class CbmVertex : public TNamed
{
  ...
  public:
     ...
     **/
    CbmVertex(const char* name, const char* title, Double_t x, Double_t y,
              Double_t z, Double_t chi2, Int_t ndf, Int_t nTracks,
    ...
    /** x coordinate
     ** value  x coordinate of vertex [cm]
     **/
    Double_t GetX() const {
      return fX;
    }
    ...
    /** y coordinate
     ** value  y coordinate of vertex [cm]
     **/
    Double_t GetY() const {
      return fY;
    }
    ...
    /** z coordinate
     ** value  z coordinate of vertex [cm]
     **/
    Double_t GetZ() const {
      return fZ;
    }
    ...
    /** chi square
     ** @value chi square of vertex fit
     **/
    ...
    /** Degrees-of-freedom
     ** value  Number of degrees-of-freedom for vertex fit
     **/
    Int_t GetNDF() const {
      return fNDF;
    }
     ...
     ** @value  Number of tracks used for the vertex fit
     **/
    ...
    /** Vertex position
     ** @param[out] Vertex position vector
     */
     ...
     ** @value Covariance matrix element (i,j)
     **/
