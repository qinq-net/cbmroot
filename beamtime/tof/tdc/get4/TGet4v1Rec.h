...
//   TGo4WinCond* fSelfTrigWind; // time window to detect trigger inside data themselves
   ...
   TH1* fAUXt[get4v10::kiMaxAux];   // time distribution of aux signals
   TH1* fSYNCt[get4v10::kiMaxSync]; // time distribution of sync signals
   TH1* fEPOCHt; // time distribution of epoch signals
   TH1* fEPOCH2t[get4v10::kiMaxGet4Roc]; // time distribution of epoch signals
   TH1* fAllSelectedT; // time distribution of all selected hits in an event
   TH1* fSelectedT[get4v10::kiMaxGet4Roc][get4v10::kuNbChan]; // time distribution of hits selected in an event
   ...
   TH1* fSyncLongT[get4v10::kiMaxSync]; // Long time distribution of sync signals
   ...
   uint64_t fLastAuxTm[get4v10::kiMaxAux];   // last time of rising edge of AUX signals
   uint64_t fLastSyncTm[get4v10::kiMaxSync]; // last time of SYNC signals
   uint32_t fLastSyncId[get4v10::kiMaxSync]; // last ID of SYNC signals
   ...
   UInt_t   fuCurrEpoch2[get4v10::kiMaxGet4Roc];  // current epoch2 for each get4 chip
   UInt_t   fuEpoch2Cycle[get4v10::kiMaxGet4Roc]; // Number of time the epoch2 counter cycled
   TH1 *fDistribEpochs;
   TH2 *fDistribEpochs2;
   TH2 *fEpochShiftsPerChip;
   TH2 *fEpochShiftsDurationPerChip;
   Int_t    fiEpochShift[get4v10::kiMaxGet4Roc];
   UInt_t   fuNbShiftedEpochs[get4v10::kiMaxGet4Roc];
   TH2 *fEpochShiftsDuration[get4v10::kiMaxGet4Roc];
   ...
   Bool_t fbEpochSinceTrigger;
         // GET4s
   Bool_t fbBufferWithLastFullEpoch2[get4v10::kiMaxGet4Roc];
   std::vector<TGet4v1MessageExtended> fPrevEpochs2Buffer[get4v10::kiMaxGet4Roc][2]; // buffer of all get4 messages in current epoch and previous one
   Bool_t bLookInPreviousEpoch[get4v10::kiMaxGet4Roc];
   Bool_t bLookInNextEpoch[get4v10::kiMaxGet4Roc];
   Bool_t fbEpoch2SinceTrigger[get4v10::kiMaxGet4Roc];

      // HitsSelection
   Bool_t fbSelectionRocDone;
   Bool_t fbSelectionDone[get4v10::kiMaxGet4Roc];
   Bool_t fbDataTimeOut[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   Bool_t fbDataFallingOut[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   TH1* fTrigger_Get4Channel[get4v10::kiMaxGet4Roc][get4v10::kuNbChan]; // time shift between last trigger and hit in this Get4 channel
   TH1* fTriggerMs_Get4Channel[get4v10::kiMaxGet4Roc][get4v10::kuNbChan]; // time shift between last trigger and hit in this Get4 channel
   TH1* fTriggerS_Get4Channel[get4v10::kiMaxGet4Roc][get4v10::kuNbChan]; // time shift between last trigger and hit in this Get4 channel
   ...
   TH1 *fChipRateEvolution[get4v10::kiMaxGet4Roc];
   TH1 *fChannelRateEvolution[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   Double_t fdRateEvolutionBinSize;
   UInt_t fuNbHitsChipEpoch[get4v10::kiMaxGet4Roc];


   /*
    * 24 & 32 bits variables & histograms
    */
   TH1 *fRawTot[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   TH1 *fTot[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];

   /*
    * 24 bits specific variables & histograms
    */
   Bool_t fb24bitsReadoutDetected;
   Get4v1Hit fHitTemp24[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   UInt_t   fuEpochWithData[get4v10::kiMaxGet4Roc]; // Data flag for suppressed epoch mode
   std::vector<TGet4v1MessageExtended> fEpSuppBuffer[get4v10::kiMaxGet4Roc]; // temp buffer in supp epoch mode to wait for epoch message
   ...
   Bool_t fbDllFlag[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   TH2 *fGet4V1DllLockBit;

   TGet4v1MessageExtended fLastExtMess[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   TH2 *fGet4V1HitsDistanceNs[get4v10::kiMaxGet4Roc];
   TH2 *fGet4V1HitsDistanceUs[get4v10::kiMaxGet4Roc];
   TH2 *fGet4V1HitsDistanceMs[get4v10::kiMaxGet4Roc];
   TH2 *fGet4V1HitsDistanceS[get4v10::kiMaxGet4Roc];

   /*
    * Debug Histograms for GET4 v1.x
    */
   TH1 *fLeadingFTS[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   TH1 *fTrailingFTS[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   TH1 *fLeadingDnl[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   TH1 *fLeadingDnlSum[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   TH1 *fTrailingDnl[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
   TH1 *fTrailingDnlSum[get4v10::kiMaxGet4Roc][get4v10::kuNbChan];
