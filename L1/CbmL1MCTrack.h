...
class CbmL1MCTrack
{
 public:
  ...
  CbmL1MCTrack()
    :mass(0.),q(0.),p(0.),x(0.),y(0.),z(0.),px(0.),py(0.),pz(0.),time(0.),ID(-1), iFile(-1), iEvent(-1), mother_ID(-1),pdg(-1),Points(),StsHits(),
  ...
  CbmL1MCTrack(int _ID)
    :mass(0.),q(0.),p(0.),x(0.),y(0.),z(0.),px(0.),py(0.),pz(0.),time(0.),ID(_ID), iFile(-1), iEvent(-1), mother_ID(-1),pdg(-1),Points(),StsHits(),
