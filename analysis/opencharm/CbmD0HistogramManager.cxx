...
CbmD0HistogramManager::CbmD0HistogramManager()
    :FairTask("default"),
     ...
     mcMomentumMvd(),
     mcMomentumMvdTrack(),
     mcMomentumMvdStsTrack(),
     mcMomentumStsTrackMvdVertex(),
     mcMomentumKaonTrackable(),
     mcMomentumKaonTrackPID(),
     mcMomentumPion1Trackable(),
     mcMomentumPion1TrackPID(),
     mcMomentumSignal(),
     mcMomentumSignalPID(),
     diffRecoSVMCSV(),
     diffRecoSVMCSV1GeV(),
