...
void CbmAnaJpsiReport::Draw()
{
...

	  {
	   ...
	   c->Divide(2,2);
	   c->cd(1);
	   DrawH1(HM()->H1("fhMcMomElectrons"));
	   c->cd(2);
	   DrawH2(HM()->H2("fhMcPtYElectrons"));
	   c->cd(3);
	   TH1D* ProjX = HM()->H2("fhMcPtYElectrons")->ProjectionX();
	   TH1D* ProjY = HM()->H2("fhMcPtYElectrons")->ProjectionY();
	   DrawH1(ProjX);
	   c->cd(4);
	   DrawH1(ProjY);
	  }

	  {
	    ...
	    DrawH1(HM()->H1("fhNofStsHitsInEvent"));
	  }

	  {
	    ...
	    DrawH1(HM()->H1("fhNofStsHitsInEvent"));
	    c->cd(2);
	    DrawH1(HM()->H1("fhNofRichHitsInEvent"));
	    c->cd(3);
	    DrawH1(HM()->H1("fhNofTrdHitsInEvent"));
	    c->cd(4);
	    DrawH1(HM()->H1("fhNofTofHitsInEvent"));
	  }
