...
*/
	...
	{
		CbmRichRing* ringradius= (CbmRichRing*) (fRichHits->At(i));
		Double_t radius	= ringradius->GetRadius();
...
//RICH
	...
	fHM->Create1<TH1D>("fh_rich_ring_radius","fh_rich_ring_radius; Ring Radius; Yield", 6, -0.5, 5.5);
