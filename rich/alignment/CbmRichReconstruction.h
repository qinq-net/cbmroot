...
public:
   ...
   void SetMirrorMisalignmentCorrectionParameterFile(string s){fPathToMirrorMisalignmentCorrectionParameterFile = s + "/correction_table/correction_param_array.txt";}
