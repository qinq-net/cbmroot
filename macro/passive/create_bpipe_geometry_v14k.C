...
void create_bpipe_geometry_v14k()
{
  ...
  infoFile << "	  pipe_v14k = pipe_v14e + fixed sizes of vacuum chamber for mvd_v14a" << endl << endl;
  ...
  infoFile << " one @ 220mm with R600mm and 0.7mm thickness, second one of iron @ 6000mm " << endl;
  infoFile << " with R600mm and 0.2mm thickness. The STS section is composed of cylinder " << endl;
  infoFile << " D(z=220-500mm)=36mm and cone (z=500-1700mm). All sections of the beam pipe " << endl;
  infoFile << " with conical shape have half opening angle 2.5deg. The PSD section of the " << endl;
  infoFile << " beam pipe is missing because it is planned that it will be part of PSD " << endl;
