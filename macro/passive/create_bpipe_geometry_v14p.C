...
void create_bpipe_geometry_v14p()
{
  ...
  infoFile << "	  pipe_v14p = pipe_v14j + fixed sizes of vacuum chamber for mvd_v14a" << endl << endl;
  ...
  infoFile << " cave as mother volume. The beam pipe consists of few sections excluding " << endl;
  infoFile << " RICH section (1700-3700mm) because it is part of the RICH geometry. Each " << endl;
