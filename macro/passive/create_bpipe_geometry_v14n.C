...
void create_bpipe_geometry_v14n()
{
  ...
  infoFile << "	  pipe_v14n = pipe_v14h + fixed sizes of vacuum chamber for mvd_v14a" << endl << endl;
  ...
  infoFile << " and 0.7mm thickness, second one of iron @ 8800mm with R600mm and 0.2mm " << endl;
  infoFile << " thickness. The STS section is composed of cylinder D(z=220-500mm)=22mm and " << endl;
  infoFile << " cone (z=500-1700mm). The STS (conical part) and RICH sections have half " << endl;
  infoFile << " opening angle 1.6deg as a result of optimization. For downstream detectors " << endl;
  infoFile << " the half opening angle of sections is left the same (2.5deg) as in SIS-100 " << endl;
  infoFile << " and section have cylindrical shape at z=6000-8800mm - it must be regarded " << endl;
  infoFile << " as an intermediate iteration, expecting feedback from subdetectors' groups." << endl;
