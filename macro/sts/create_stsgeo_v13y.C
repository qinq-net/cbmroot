...
void create_stsgeo_v13y(const char* geoTag="v13y")
{
  ...
  */
  ...
  ladderTypes[6] = 2;
  ladderTypes[7] = 3;
  TGeoVolume* station01 = ConstructStation("Station01", 0, nLadders, ladderTypes, 
					rHole);
  ...
  ladderTypes[10] = 3;
  ladderTypes[11] = 4;
  TGeoVolume* station02 = ConstructStation("Station02", 1, nLadders, ladderTypes, 
					rHole);
  ...
  ladderTypes[12] = 8;
  ladderTypes[13] = 9;
  TGeoVolume* station04 = ConstructStation("Station04", 3, nLadders, ladderTypes, 
					rHole);
  ...
  ladderTypes[12] = 13;
  ladderTypes[13] = 14;
  TGeoVolume* station05 = ConstructStation("Station05", 4, nLadders, ladderTypes, 
					rHole);
  ...
  ladderTypes[12] = 13;
  ladderTypes[13] = 14;
  TGeoVolume* station06 = ConstructStation("Station06", 5, nLadders, ladderTypes, 
					rHole);
  ...
  ladderTypes[14] = 13;
  ladderTypes[15] = 14;
  TGeoVolume* station07 = ConstructStation("Station07", 6, nLadders, ladderTypes, 
					rHole);
  ...
  ladderTypes[14] = 13;
  ladderTypes[15] = 14;
  TGeoVolume* station08 = ConstructStation("Station08", 7, nLadders, ladderTypes, 
					rHole);
