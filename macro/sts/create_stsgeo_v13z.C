...
TGeoVolume* ConstructModule(const char* name, 
  ...
  if ( gkConstructCables && cableLength > 0.0001 ) {
    ...
    TGeoTranslation* cableTrans1 = new TGeoTranslation("cableTrans1",
						      cableXpos - 1* cableX/2.,
						      cableYpos,
						      cableZpos);
    module->AddNode(cable, 1, cableTrans1);

    TGeoTranslation* cableTrans2 = new TGeoTranslation("cableTrans2",
						      cableXpos + 1* cableX/2.,
						      cableYpos,
						      cableZpos);
    module->AddNode(cable, 2, cableTrans2);

    TGeoTranslation* cableTrans3 = new TGeoTranslation("cableTrans3",
						      cableXpos - 3* cableX/2.,
						      cableYpos,
						      cableZpos);
    module->AddNode(cable, 3, cableTrans3);

    TGeoTranslation* cableTrans4 = new TGeoTranslation("cableTrans4",
						      cableXpos + 3* cableX/2.,
						      cableYpos,
						      cableZpos);
    module->AddNode(cable, 4, cableTrans4);

    TGeoTranslation* cableTrans5 = new TGeoTranslation("cableTrans5",
						      cableXpos - 5* cableX/2.,
						      cableYpos,
						      cableZpos);
    module->AddNode(cable, 5, cableTrans5);

    TGeoTranslation* cableTrans6 = new TGeoTranslation("cableTrans6",
						      cableXpos + 5* cableX/2.,
						      cableYpos,
						      cableZpos);
    module->AddNode(cable, 6, cableTrans6);

    TGeoTranslation* cableTrans7 = new TGeoTranslation("cableTrans7",
						      cableXpos - 7* cableX/2.,
						      cableYpos,
						      cableZpos);
    module->AddNode(cable, 7, cableTrans7);

    TGeoTranslation* cableTrans8 = new TGeoTranslation("cableTrans8",
						      cableXpos + 7* cableX/2.,
						      cableYpos,
						      cableZpos);
