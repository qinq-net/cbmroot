...
// 2016-07-14 - DE - v17a_1h - build a TRD consisting of a single module in layer 1 for debugging
...
const Bool_t IncludeKaptonFoil  = false;  // false;  // true, if entrance window is included in geometry
const Bool_t IncludeGasFrame    = true;  // false;  // true, if frame around gas volume is included in geometry
const Bool_t IncludePadplane    = false;  // false;  // true, if padplane is included in geometry
const Bool_t IncludeBackpanel   = false;  // false;  // true, if backpanel is included in geometry

const Bool_t IncludeFebs        = false;  // false;  // true, if FEBs are included in geometry
...
void Create_TRD_Geometry_v16a_1h() {
