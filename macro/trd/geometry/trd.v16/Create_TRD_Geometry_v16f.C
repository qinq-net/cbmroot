...
const Int_t GbtxPerModule[NofModuleTypes] = { 14,  8,  5,  0, 15, 10,  5,  3 }; // for .geo.info - TODO: merge with above GbtxPerRob
const Int_t RobTypeOnModule[NofModuleTypes] = { 77, 53,  5,  0, 555, 55,  5,  3 }; // for .geo.info - TODO: merge with above GbtxPerRob
