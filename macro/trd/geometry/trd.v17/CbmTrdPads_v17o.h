...
// module type 5
// number of pads: 144 x 12 = 1728
// pad size sector 1:  0.60 cm x  7.25 cm =  4.38 cm2
// pad size sector 0:  0.60 cm x  7.25 cm =  4.38 cm2
    { { 87.0, 29.00, 87.0/144,  7.25 },
      { 87.0, 29.00, 87.0/144,  7.25 },
      { 87.0, 29.00, 87.0/144,  7.25 } },
...
// pad size sector 1:  0.60 cm x 21.75 cm = 13.14 cm2
// pad size sector 0:  0.60 cm x 21.75 cm = 13.14 cm2
    { { 87.0, 21.75, 87.0/144, 21.75 },
      { 87.0, 43.50, 87.0/144, 21.75 },
      { 87.0, 21.75, 87.0/144, 21.75 } },

// module type 8
// number of pads: 144 x  6 =  864
// pad size sector 1:  0.60 cm x 14.50 cm =  8.76 cm2
// pad size sector 0:  0.60 cm x 14.50 cm =  8.76 cm2
    { { 87.0, 29.00, 87.0/144, 14.50 },
      { 87.0, 29.00, 87.0/144, 14.50 },
      { 87.0, 29.00, 87.0/144, 14.50 } } };
