...
const Int_t GbtxPerModule[NofModuleTypes] = {   12,  6,  3,  0,  0,  12,  9,  3 }; // for .geo.info - TODO: merge with above GbtxPerRob
const Int_t RobTypeOnModule[NofModuleTypes]={ 3333, 33,  3,  0,  0,3333,333,  3 }; // for .geo.info - TODO: merge with above GbtxPerRob
