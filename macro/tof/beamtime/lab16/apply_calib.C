...
void apply_calib(Int_t nEvents = 100000000, char *cFileId="CbmTofPiHd_Plastic_29Jul2007_16211200704")
{
	TStopwatch timer;
	timer.Start();
	...
	tofCalibTrb->SaveCalibData(kTRUE);
	...
	tofCalibTrb->SetReferenceBoard(2);
