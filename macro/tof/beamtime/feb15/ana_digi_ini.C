void ana_digi_ini(Int_t nEvents = 1000000, Int_t calMode=0, Int_t calSel=-1, Int_t calSmType=2, Int_t RefSel=1, char *cFileId="MbsTrbThu1715", Int_t iSet=0, Int_t iBRef=5) 
{
  Int_t iVerbose = 1;
