...
can->cd(9);
 ...
 cout << Form("<%s> 1-sig timing resolution at lower index %d (-> %6.1f ps): %6.1f ps, RMS: %6.1f ps from  %6.0f entries of %6.0f (%6.3f)",cHist,BL,BLL,BRes,Brms,BEntries,NEntries,BEntries/NEntries) <<endl; 
}
