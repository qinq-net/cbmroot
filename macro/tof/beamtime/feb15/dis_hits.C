void dis_hits(Int_t nEvents=10, Int_t iSel=1, Int_t iGenCor=1, char *cFileId="Cern", Int_t iSet=0, Int_t iSel2=0) 
{ // display hits in event display 
  ...
  CbmEvDisTracks *Track =  new CbmEvDisTracks ("Tof Tracks",5);
  fMan->AddTask(Track);
