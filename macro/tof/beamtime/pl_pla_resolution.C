void pl_pla_resolution(UInt_t uTdcNumber1, UInt_t uChNumber1, UInt_t uTdcNumber2, UInt_t uChNumber2,
                       UInt_t uTdcNumber3, UInt_t uChNumber3, UInt_t uTdcNumber4, UInt_t uChNumber4)
{
  ...
  tHistogram->GetXaxis()->SetTitle(Form("dt PLA (%u,%u;%u,%u) - (%u,%u;%u,%u) [ps]",uTdcNumber1,uChNumber1,uTdcNumber2,uChNumber2,uTdcNumber3,uChNumber3,uTdcNumber4,uChNumber4));
  ...
  for(Long64_t lBranchEntry = 0; lBranchEntry < lBranchEntries; lBranchEntry++)
  {
    ...
    {
      tHistogram->Fill( 0.5*(((TTofCalibData*)tArray->At(iDataIndex1))->GetTime()+((TTofCalibData*)tArray->At(iDataIndex2))->GetTime())
