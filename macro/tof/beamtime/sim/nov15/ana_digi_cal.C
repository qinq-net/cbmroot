...
void ana_digi_cal(Int_t iNEvents, Int_t iCalMode, Int_t iCalSel, Int_t iCalRPC, Int_t iRefSel,
                  const TString& tUnpackDir, Int_t iDut, Int_t iMRef, Int_t iBRef, Double_t dDeadTime)
{
  ...
  TString tOutputFile           = "./digi_cal.out.root";
  TString tHistoFile            = "./calib_cluster_cal.hst.root";
  ...
  if(!gGeoManager)
  {
    std::cout << "-E- ana_digi_cal: FAIRGeom not found in geometry file!" << std::endl;
    return;
  }
  ...
  switch (iCalMode)
  {
    ...
    case 1:
      ...
      tTofTestBeamClust->PosYMaxScal(50.0);
      break;
    case 11:
      tTofTestBeamClust->SetTRefDifMax(4.);
      tTofTestBeamClust->PosYMaxScal(2.0);
      break;   
    case 21:
    ...
    case 42:
    case 43:
      tTofTestBeamClust->SetTRefDifMax(13.);
    ...
    // velocity dependence
    case 4:
      tTofTestBeamClust->SetTRefDifMax(60.);
      tTofTestBeamClust->PosYMaxScal(1.5);
      break;
    case 14:
      tTofTestBeamClust->SetTRefDifMax(6.);
    ...
    default:
      std::cout << "-E- ana_digi_cal: calibration mode not implemented!" << std::endl;
      return;
  }
  ...
  std::cout << "-I- ana_digi_cal: initializing run..." << std::endl;
  tRun->Init();

  std::cout << "-I- ana_digi_cal: starting run..." << std::endl;
  tRun->Run(0, iNEvents);
