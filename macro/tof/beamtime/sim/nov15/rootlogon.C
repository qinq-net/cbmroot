...
//  gStyle->SetLineScalePS(2.0);
  ...
  gSystem->AddIncludePath(Form("-I%s/include",gSystem->Getenv("SIMPATH")));
  gSystem->AddIncludePath(Form("-I%s/include",gSystem->Getenv("FAIRROOTPATH")));
  gSystem->AddIncludePath(Form("-I%s",gSystem->Getenv("VMCWORKDIR")));
