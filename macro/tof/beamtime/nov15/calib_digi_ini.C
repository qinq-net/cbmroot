...
void calib_digi_ini(Int_t nEvents = 10000, Int_t calMode = 0, Int_t calSel = -1, Int_t calSm = 200, Int_t RefSel = 1, TString cFileId = "CbmTofSps_27Nov1728", Int_t iCalSet = 0)
{
  TStopwatch timer;
  timer.Start();
