void Run_reco_geo_opt(Int_t nEvents = 10,  float PMTrotX=2, float PMTrotY=2, int RotMir=-10, int GeoFile=1)
{
  ...
  // TString outDir="/nas/Tariq/GeoOpt/RotPMT/NewGeo/";
  // if(GeoFile==0){outDir="/nas/Tariq/GeoOpt/RotPMT/VeryOldGeo/";}
  // if(GeoFile==1){outDir="/nas/Tariq/GeoOpt/RotPMT/OldGeo/";}
  // if(GeoFile==2){outDir="/nas/Tariq/GeoOpt/RotPMT/NewGeo/";}

   TString ParFile = outDir + "Parameters_RichGeo_"+RotTxt+"_Pt0to4.root";
   TString SimFile = outDir + "Sim_RichGeo_"+RotTxt+"_Pt0to4.root";
  // TString ParFile = "/nas/Tariq/GeoOpt/RotPMT/NewGeo/Parameters_RichGeo_"+RotTxt+"_Pt0to4.root";
  // TString SimFile = "/nas/Tariq/GeoOpt/RotPMT/NewGeo/Sim_RichGeo_"+RotTxt+"_Pt0to4.root";
  TString RecFile = outDir + "Rec_RichGeo_"+RotTxt+"_Pt0to4.root";
  //TString RecFile = "/data/GeoOpt/RotPMT/NewGeo/Rec_RichGeo_"+RotTxt+"_Pt0to4.root";
  if(MomCase==1){
