#include <iostream>
#include <fstream>  
void CreateGDMLfile_April2015_ModOct2015(float pmt_pos_y_addend = 0, float pmt_pos_z_addend = 0, int RotMir=-10, float PMTrotX=5, float PMTrotY=5 , float EnlargedPMTWidth=40., float EnlargedPMTHight=20.,int DefaultDims=0, int DefaultDims_LargePMT=0){
  ...
  if(DefaultDims==1){
    ...
    if(DefaultDims_LargePMT==1){Delta_pmt_width=EnlargedPMTWidth; Delta_pmt_height=EnlargedPMTHight;}
