void Run_Ana_GeoOpt_Batch(Int_t nEvents = 10,  int PMTtransY=0, int PMTtransZ=0,  float PMTrotX=2, float PMTrotY=2, int RotMir=-10)
{
  ...
  TString ParFile = outDir + "Parameters_"+GeoText+"_"+RotMirText+"_"+PMTRotText+"_"+PMTTransText+"_"+MomText+ExtraText+"root";
  TString SimFile = outDir + "Sim_"+GeoText+"_"+RotMirText+"_"+PMTRotText+"_"+PMTTransText+"_"+MomText+ExtraText+"root";
  TString RecFile = outDir + "Rec_"+GeoText+"_"+RotMirText+"_"+PMTRotText+"_"+PMTTransText+"_"+MomText+ExtraText+"root";

  TString AnaFile = outDir + "Ana_"+GeoText+"_"+RotMirText+"_"+PMTRotText+"_"+PMTTransText+"_"+MomText+ExtraText+"root";
