...
void run_rich_event_display()
{
   ...
   cbmlibs();
    ...
    TString paramFile =  outDir + "param.newrich.3.root";
    TString mcFile = outDir + "mc.newrich.3.root";
    TString recoFile = outDir + "reco.newrich.3.root";
    TString outFile = outDir + "ed.newrich.3.root";
