...
//    if (geom == 0) {setupName = "setup_align";}
    ...
    else if (input == 3) {urqmdFile = "/data/ROOT6/trunk/input/urqmd.auau.8gev.centr.00010.root";}
    else if (input == 4) {urqmdFile = "/data/ROOT6/trunk/input/urqmd.auau.25gev.centr.00010.root";}
