...
void run_sim_jordan(int nEvents = 5, int geom_nb = 0)
{
  ...
  TString outdir = "/home/jordan/Desktop/"; //Documents/CbmRoot/Mirr_Align_Sim/mirror_alignment/";
  ...
  float StartPhi=0., EndPhi=180.;	// StartPhi=141.98, EndPhi=142.;      Phi = azimuthal angle
  float StartTheta=2.5, EndTheta=25.;	// StartTheta=12.72, EndTheta=12.74;  Theta = polar angle

  // e- Generator
  FairBoxGenerator* boxGen1 = new FairBoxGenerator(11, 1);	//Pdg code and number of particles produced.
  boxGen1->SetPtRange(3.,10.);			//Energy range between 3 and 10 GeV.
