void run_reco_jordan(Int_t nEvents = 300)
{
    ...
    TString mcFile = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/test/mc.00090.root";
    TString parFile = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/test/param.00090.root";
    TString recoFile = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/test/reco.00090.root";
    TString dir = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/pluto/";
    //TString runTitle = "Align_Study";
    TString runTitle = "PMT_Mapping_urqmd_TauFit";
