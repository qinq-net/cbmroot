...
void DrawPoints(int geom_nb = 0)
{
  ...
  char PATH[256];
  //sprintf(PATH, "/home/jordan/Desktop/misalignment_correction/Sim_RichGeo_jordan_%d.root", geom_nb);
  sprintf(PATH, "/data/cbm/cbmroot/macro/rich/alignment/misalignment_correction/Sim_Outputs/TrackExtrapolation/Sim_RichGeo_jordan_NewGeo.root");
