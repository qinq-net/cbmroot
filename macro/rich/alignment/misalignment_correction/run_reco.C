void run_reco(Int_t nEvents = 10000)
{
    ...
    //TString dir = "/data/Cbm_Root/misalignment_correction/run_sim/Misalignment_OneMirr/OneMirr_RotXY/-0pt3X_0pt5Y/";
    //TString dir = "/data/Cbm_Root/misalignment_correction/run_sim/Misalignment_OneMirr/Study_OneMirr/X_axis/2deg/";
    //TString dir = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Multi_el_per_event/multi_el_per_evt_phi[80-175]_theta[3-24pt5]/";
//    TString dir = "Sim_Outputs/PMTMapping/";
    TString dir = "Sim_Outputs/TrackExtrapolation/";
    TString runTitle = "Align_Study";
    TString runTitle = "PMT_Mapping_multi_el_TauFit";
    TString AxisRotTitle = "";
//    TString mcFile = dir + "Sim_RichGeo_jordan_testPmtRot.root";
//    TString parFile = dir + "Parameters_RichGeo_jordan_testPmtRot.root";
//    TString recoFile = dir + "Rec_RichGeo_jordan_testPmtRot.root";
    TString mcFile = dir + "Sim_RichGeo_jordan_NewGeo.root";
    TString parFile = dir + "Parameters_RichGeo_jordan_NewGeo.root";
    TString recoFile = dir + "Rec_RichGeo_jordan_NewGeo.root";

    //TString dir = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/test_urqmd/";
    //TString mcFile = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/test_urqmd/mc.00090.root";
    //TString parFile = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/test_urqmd/param.00090.root";
    //TString recoFile = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/test_urqmd/reco.00090.root";

    std::string resultDir = "recqa_0001/";
    TString trdHitProducerType = "smearing";
    int nofNoiseHitsInRich = 0.; //220;
    double collectionEff = 1.0;
    double sigmaErrorRich = 0.; //0.06;
    double crosstalkRich = 0.; //0.02
    ...
    run->AddTask(kalman);
    CbmL1* l1 = new CbmL1();
    l1->SetStsMaterialBudgetFileName(stsMatBudgetFileName);
    run->AddTask(l1);
	...
	richAlign->SetRunTitle(runTitle);
        richAlign->SetAxisRotTitle(AxisRotTitle);
