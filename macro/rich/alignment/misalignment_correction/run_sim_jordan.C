void run_sim_jordan(Int_t nEvents = 300)
{
   TTree::SetMaxTreeSize(90000000000);
	...
	TString parFile = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/pluto/param.00090.root";
	TString geoFile = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/pluto/geofilefull.00090.root";
	TString outFile = "/data/Cbm_Root/misalignment_correction/run_sim/PMT_Mapping/Urqmd/pluto/mc.00090.root";

	//TString parFile = "/data/Cbm_Root/misalignment_correction/event_Display/test_urqmd/param.00090.root";
	//TString geoFile = "/data/Cbm_Root/misalignment_correction/event_Display/test_urqmd/geofilefull.00090.root";
	//TString outFile = "/data/Cbm_Root/misalignment_correction/event_Display/test_urqmd/mc.00090.root";
	...
	//TString richGeom= "rich/rich_v14a_3e.root";
        TString richGeom = "rich/misalignment_correction/rich_v14b_misaligned_0.root";
	...
	TString plutoFile = ""; // "/data/Cbm_Root/pluto/pluto.auau.25gev.jpsi.epem.0001.root";
	...
	if (electrons == "yes"){
		...
		boxGen2->SetPtRange(9.9,9.95);
		boxGen2->SetPhiRange(110.,175.);
		boxGen2->SetThetaRange(2.5,27.5);
		boxGen2->SetCosTheta();
		boxGen2->Init();
