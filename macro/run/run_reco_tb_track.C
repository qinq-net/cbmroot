...
void run_reco_tb_track()
 {
  ...
  // in which they are supposed to be stored suring digitisation.
  ...
  stsCluster->UseDaq();
  stsCluster->UseTbClusterFinder(20.);
  ...
  // --- Matching to MC (needed by event builder)
