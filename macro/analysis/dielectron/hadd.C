...
void hadd() {
    ...
    CbmHaddBase::AddFilesInDir(dir + "/omegaepem/", fileArray, "analysis", nofFiles);
    CbmHaddBase::AddFilesInDir(dir + "/phi/", fileArray, "analysis", nofFiles);
    CbmHaddBase::AddFilesInDir(dir + "/omegadalitz/", fileArray, "analysis", nofFiles);
    CbmHaddBase::AddFilesInDir(dir + "/rho0/", fileArray, "analysis", nofFiles);

    CbmHaddBase::AddFilesInDir(dir + "/rho0/", fileArray, "litqa", nofFiles);
