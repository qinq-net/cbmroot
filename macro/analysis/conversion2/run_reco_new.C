...
void run_reco_new(Int_t nEvents = 2, Int_t file_nr = 1, const char* setup = "light_sis100_electron")
{
...
//1  cout << "macro/run/run_reco.C using: " << trdDigi << endl;

  TObjString tofDigiFile(paramDir + tofDigi);
  parFileList->Add(&tofDigiFile);
//1  cout << "macro/run/run_reco.C using: " << tofDigi << endl;
...
//        richReco->SetProjectionName("tgeo"); //hz
