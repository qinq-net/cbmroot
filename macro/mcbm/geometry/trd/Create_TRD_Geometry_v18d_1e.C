...
//  const Double_t AperY[3] = { 3.5*DetectorSizeY[1], 4.5*DetectorSizeY[1], 5*DetectorSizeY[1] };  // inner aperture in Y of support structure for stations 1,2,3
  const Double_t AperX[3] = { 2.5*DetectorSizeX[0], 2.5*DetectorSizeX[0], 2.5*DetectorSizeX[0] };  // inner aperture in X of support structure for stations 1,2,3
  const Double_t AperY[3] = { 2.5*DetectorSizeY[0], 2.5*DetectorSizeY[0], 2.5*DetectorSizeY[0] };  // inner aperture in Y of support structure for stations 1,2,3
  ...
  const Double_t AperYbot[3] = { 2.5*DetectorSizeY[0], 4.5*DetectorSizeY[1], 5*DetectorSizeY[1] };  // inner aperture for station1
...
//      trd_1->AddNode(trd_I_slope_vol1, 14, trd_I_slope_combi04);
      TGeoCombiTrans* trd_I_slope_combi03 = new TGeoCombiTrans( (DetectorSizeX[0]/2.+I_height/2.),-zBarPosYbot[0], (PilPosZ[0]+PilPosZ[1])/2., rotz090);
      trd_1->AddNode(trd_I_slope_vol1, 13, trd_I_slope_combi03);
      TGeoCombiTrans* trd_I_slope_combi04 = new TGeoCombiTrans(-(DetectorSizeX[0]/2.+I_height/2.),-zBarPosYbot[0], (PilPosZ[0]+PilPosZ[1])/2., rotz090);
      trd_1->AddNode(trd_I_slope_vol1, 14, trd_I_slope_combi04);
    }
