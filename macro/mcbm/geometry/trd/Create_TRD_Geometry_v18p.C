...
const Int_t   LayerType[MaxLayers]        = {11, 11, 10, 11, 20, 21, 20, 21, 30, 31};  // ab: a [1-4] - layer type, b [0,1] - vertical/horizontal pads
...
const Int_t GbtxPerModule[NofModuleTypes] = {  3, 10,  5, 18,  0, 10,  5,  3 }; // for .geo.info - TODO: merge with above GbtxPerRob
const Int_t RobTypeOnModule[NofModuleTypes]={  3, 55,  5,333333,  0, 55,  5,  3 }; // for .geo.info - TODO: merge with above GbtxPerRob
...
const Int_t AsicsPerFeb[NofModuleTypes]   = {105,210,210,410,108,108,108,108 }; // %100 gives number of ASICs on FEB, /100 gives grouping
