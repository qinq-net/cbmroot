...
//    } else {
     ...
     //      ConstructFrameBox("FrameBox", sliceVol, xu/2.);
      ...
      ladder->AddNode(fullFrameBoxVol, 2, new TGeoCombiTrans(name+"_FullFrameBox_posrot", 0.,  1*gkFrameStep, -ladderZ/2.-(xu/2.+sqrt(2.)*gkFrameThickness/2.)/2., fullFrameRot));
      ladder->AddNode(fullFrameBoxVol, 3, new TGeoCombiTrans(name+"_FullFrameBox_posrot", 0.,  0*gkFrameStep, -ladderZ/2.-(xu/2.+sqrt(2.)*gkFrameThickness/2.)/2., fullFrameRot));
      ladder->AddNode(fullFrameBoxVol, 4, new TGeoCombiTrans(name+"_FullFrameBox_posrot", 0., -1*gkFrameStep, -ladderZ/2.-(xu/2.+sqrt(2.)*gkFrameThickness/2.)/2., fullFrameRot));
      ladder->AddNode(fullFrameBoxVol, 5, new TGeoCombiTrans(name+"_FullFrameBox_posrot", 0., -2*gkFrameStep, -ladderZ/2.-(xu/2.+sqrt(2.)*gkFrameThickness/2.)/2., fullFrameRot));
      ladder->GetShape()->ComputeBBox();
//    }
  }
